...
class BaseExporter(ABC, Generic[FW, T_IO]):
    ...
    def export_board(self, board: Board, fp: T_IO, **kwargs: Any) -> None:
        """Exports a Board to a file."""
...
class JSONLinesExporter(BaseExporter[J, IO[str]]):
